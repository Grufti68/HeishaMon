...
static const char websocketJS[] PROGMEM =
  ...
  "        if (jsonData['log']) obj.value += jsonData.log.timestamp + \" (\" + jsonData.log.uptime + \"): \" + jsonData.log.text + \"\\n\";"
...
static const char refreshJS[] PROGMEM =
  ...
  "       refreshTable(jsonData);"
  "       setTimeout(loadContentJson, 30000);"
  "     }"
  "   }"
  " }"
  " function refreshTable(data){"
  "   let heishavalues = document.getElementById('heishavalues');"
  "   if (data[\"heatpump\"] && heishavalues) {"
